...
function addon:registerSounds()
    ...
    -- Add spell "Ráfaga emanadora" (388923) journal sections:25731
    ...
    -- Add spell "Toque de sanación" (396640) journal sections:25687 25688 25710
    ...
    -- Add spell "Ciclón viviente" (393211) journal sections:25210 25215 25212 26109
    ...
    -- Add spell "Vulnerabilidad sónica" (397210) journal sections:25208 26108
    ...
    -- Add spell "Energía sin control" (388951) journal sections:25778 25779 25780
    ...
    -- Add spell "Vacío de poder" (388822) journal sections:25777
    ...
    -- Add spell "Bomba de energía" (374352) journal sections:25665
    ...
    -- Add spell "Abusar de los débiles" (389788) journal sections:25781
    ...
    -- Add spell "Carga indómita" (381419) journal sections:24732 25328
    ...
    -- Add spell "Rápidos de sanación superior" (377950) journal sections:24734 25336
    ...
    -- Add spell "Látigo de vid" (377559) journal sections:25300
    ...
    -- Add spell "Salto elástico" (384558) journal sections:25633 24735 25416
    ...
    -- Add spell "Tácticas del líder de caza" (387890) journal sections:25627
    ...
    -- Add spell "Frenesí hambriento" (384764) journal sections:25418 25419
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1204 = BAA:createEAVoicePack("Salas de Infusión", 503, 1204, "ES")


    -- Expansion "Dragonflight" (503)

    -- Instance "Salas de Infusión" (1204) (DUNGEON)


    -- Encounter "Vigía Irideus" (2504)
    ...
    -- Add spell "Oleada estática" (384015) journal sections:25745 25395
    vp1204:addSpellPath(2504,384015,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1204\\2504\\384015.ogg")

    -- Add spell "Puño titánico" (384524) journal sections:25745 25389
    ...
    -- Add spell "Explosión purificadora" (389443) journal sections:25744 25743 25768
    ...
    -- Add spell "Famélico y furioso" (385743) journal sections:25473 25495
    ...
    -- Add spell "Efluvios tóxicos" (385451) journal sections:25474
    ...
    -- Add spell "Ciclón de escarcha" (390006) journal sections:25787
    ...
    -- Add spell "Glóbulo imbuido" (387363) journal sections:25529 25610
    ...
    -- Add spell "Inundación enfocada" (387571) journal sections:25529 25606 25607
    ...
    -- Encounter "Chargath, Perdición de las Escamas" (2490)
    ...
    -- Add spell "Suelo en erupción" (374471) journal sections:25087 25109
    ...
    -- Add spell "Erupción de escoria" (395656) journal sections:25087 25108 25747
    ...
    -- Add spell "Égida llameante" (374812) journal sections:25056 26070
    vp1199:addSpellPath(2489,374812,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1199\\2489\\374812.ogg")

    -- Add spell "Erupción llameante" (375059) journal sections:25056 26070 26071
    ...
    -- Add spell "Magma líquido ardiente" (375204) journal sections:25167 25882
    vp1199:addSpellPath(2494,375204,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1199\\2494\\375204.ogg")

    -- Add spell "Potenciación de lava" (391457) journal sections:25167 25883
    ...
    -- Encounter "Señora de la guerra Sargha" (2501)

    -- Add spell "Maldición del tesoro de dragón" (391762) journal sections:25983 26068
    vp1199:addSpellPath(2501,391762,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1199\\2501\\391762.ogg")

    -- Add spell "Varita de negación" (379020) journal sections:25983 25984
    ...
    -- Add spell "Piedra azur de poderío" (392166) journal sections:25983 25986
    ...
    -- Add spell "Botas sísmicas" (392260) journal sections:25983 25988
    ...
    -- Add spell "Erupción de llamas" (376783) journal sections:25262 25263
    ...
    -- Add spell "Erupción del dragón" (391773) journal sections:25262 25950
    ...
    -- Add spell "Persecución ardiente" (377522) journal sections:25268 25270 25271
    vp1199:addSpellPath(2501,377522,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1199\\2501\\377522.ogg")

    -- Add spell "Caparazón de magma" (391765) journal sections:25268 25270 25951
    vp1199:addSpellPath(2501,391765,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1199\\2501\\391765.ogg")

    -- Add spell "Fogón del dragón" (377204) journal sections:25267
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1202 = BAA:createEAVoicePack("Estanques de Vida Rubí", 503, 1202, "ES")


    -- Expansion "Dragonflight" (503)

    -- Instance "Estanques de Vida Rubí" (1202) (DUNGEON)


    -- Encounter "Melidrussa Ajafrío" (2488)

    -- Add spell "Despertar crías" (373046) journal sections:24999
    vp1202:addSpellPath(2488,373046,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1202\\2488\\373046.ogg")

    -- Add spell "Garras frías" (373803) journal sections:24999 25783 25013
    vp1202:addSpellPath(2488,373803,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1202\\2488\\373803.ogg")

    -- Add spell "Escalofrío primigenio" (372682) journal sections:24999 25783 25013 25009
    ...
    -- Add spell "Tormenta gélida" (372851) journal sections:25005
    ...
    -- Encounter "Kokia Pezuña de Fuego" (2485)

    -- Add spell "Ritual de vinculación de llamas" (372863) journal sections:24944
    vp1202:addSpellPath(2485,372863,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1202\\2485\\372863.ogg")

    -- Add spell "Consunción" (373087) journal sections:24944 24945 24976
    ...
    -- Add spell "Núcleo infernal" (381862) journal sections:25365 25366
    ...
    -- Add spell "Ráfaga de nubes" (385558) journal sections:25369 25479
    vp1202:addSpellPath(2503,385558,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1202\\2503\\385558.ogg")

    -- Add spell "Ráfaga de nubes interruptora" (381516) journal sections:25369 25372
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1203 = BAA:createEAVoicePack("Cámara Azur", 503, 1203, "ES")


    -- Expansion "Dragonflight" (503)

    -- Instance "Cámara Azur" (1203) (DUNGEON)


    -- Encounter "Leymor" (2492)

    -- Add spell "Brotes de línea Ley" (374364) journal sections:25097
    ...
    -- Add spell "Energía abrumadora" (384132) journal sections:25515
    vp1203:addSpellPath(2505,384132,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1203\\2505\\384132.ogg")

    -- Add spell "Potenciación de sello" (379256) journal sections:25515 25516 25517
    ...
    -- Add spell "Invocar imagen dracónica" (384223) journal sections:25512
    ...
    -- Add spell "Runa de la cámara" (388072) journal sections:25634 25636
    ...
    -- Add spell "Golpe de dragón" (384978) journal sections:25487
    ...
    -- Add spell "Erupción" (388283) journal sections:25455 25448
    ...
    -- Add spell "Pisotón tectónico" (385916) journal sections:25455 25458
    ...
    -- Add spell "Energía incontrolable" (382630) journal sections:25221
    ...
    -- Add spell "Vínculo ancestral" (392198) journal sections:25943
    ...
    -- Add spell "Viento guardián" (384808) journal sections:25552 25556 25570
    ...
    -- Add spell "Salto de espíritu" (385412) journal sections:25552 25554
    ...
    -- Add spell "Réplica" (395668) journal sections:25546 25547 26021
    ...
    -- Add spell "Agitación" (375943) journal sections:25185 25973
    ...
    -- Add spell "Cañonazo abrasador" (375286) journal sections:24783 24784
    ...
    -- Add spell "Oleada ígnea" (395647) journal sections:24783 26020
    ...
    -- Add spell "Dínamo antigua" (372716) journal sections:24935
    ...
    -- Add spell "Potenciación titánica" (372719) journal sections:24935 24934
    ...
    -- Add spell "Pisotón aplastante" (372701) journal sections:24932
    vp1197:addSpellPath(2484,372701,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1197\\2484\\372701.ogg")

    -- Add spell "Fragmentos terráneos" (372718) journal sections:24933
    ...
    -- Add spell "Máquina de calor" (369029) journal sections:24746 25572 25971
    ...
    -- Add spell "Pisotón abrasador" (369061) journal sections:25020
    ...
    -- Add spell "Erupción temporal" (377561) journal sections:25238 25239
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1205 = BAA:createEAVoicePack("Islas Dragón", 503, 1205, "ES")


    -- Expansion "Dragonflight" (503)

    -- Instance "Islas Dragón" (1205) (RAID)
    ...
    -- Add spell "Expulsión en arco" (390295) journal sections:25793
    vp1205:addSpellPath(2515,390295,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1205\\2515\\390295.ogg")

    -- Add spell "Vórtice de truenos" (385980) journal sections:25678
    ...
    -- Add spell "Colisión hendiente" (386259) journal sections:25562
    vp1205:addSpellPath(2506,386259,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1205\\2506\\386259.ogg")

    -- Add spell "Tierra volátil" (387668) journal sections:25562 25599
    ...
    -- Add spell "Erupción de magma" (389725) journal sections:25874 25876
    ...
    -- Add spell "Infusión de llamas" (391247) journal sections:25878 25879
    ...
    -- Add spell "Lluvia de destrucción" (390635) journal sections:25878 25880
    vp1205:addSpellPath(2517,390635,"Interface\\AddOns\\BAA-CurrentContent-ES\\sounds\\1205\\2517\\390635.ogg")


    -- Encounter "Liskanoth, la Perdición del Futuro" (2518)
    ...
    -- Add spell "Congelación profunda" (389762) journal sections:25889
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp313 = BAA:createEAVoicePack("Templo del Dragón de Jade", 74, 313, "ES")


    -- Expansion "Mists of Pandaria" (74)

    -- Instance "Templo del Dragón de Jade" (313) (DUNGEON)
    ...
    -- Encounter "Eremita Senda Pétrea" (664)
