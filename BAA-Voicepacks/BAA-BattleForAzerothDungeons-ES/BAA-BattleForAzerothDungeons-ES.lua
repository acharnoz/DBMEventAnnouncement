...
function addon:registerSounds()
    ...
    -- Add spell "Transfusión" (255577) journal sections:16824
    ...
    -- Add spell "Espíritu de oro" (259205) journal sections:18088
    ...
    -- Add spell "Salto tóxico" (250258) journal sections:16485
    ...
    -- Add spell "Náuseas persistentes" (250372) journal sections:17470 16488
    ...
    -- Add spell "Montón de huesos" (257483) journal sections:16834 18468
    ...
    -- Add spell "Temblor óseo" (260683) journal sections:17657
    ...
    -- Add spell "Festín de almas" (256577) journal sections:17277 17278 17279
    ...
    -- Add spell "Restos sombríos" (250036) journal sections:16422 16416
    ...
    -- Encounter "Capitán de los cielos Kragg" (2102)
    ...
    -- Add spell "Disparo de pólvora de azerita" (256106) journal sections:17146 17149
    ...
    -- Add spell "Disparo de pólvora" (256979) journal sections:17024 17028
    ...
    -- Add spell "Brebaje de Fuerte Libre cáustico" (265168) journal sections:18476 18477
    ...
    -- Add spell "Dados trucados: ¡Toda la tripulación!" (257402) journal sections:17013 17012
    ...
    -- Add spell "Tromba de cañón" (257305) journal sections:16943
    ...
    -- Add spell "Bomba de pólvora negra" (257315) journal sections:16946 16944 16945
    ...
    -- Add spell "Quemar corrupción" (267639) journal sections:18140
    ...
    -- Add spell "Deshidratación" (267626) journal sections:18141 18142
    ...
    -- Add spell "Abrir sarcófago" (271290) journal sections:18143 18147
    ...
    -- Add spell "Revés debilitador" (266237) journal sections:18264 18266
    ...
    -- Add spell "Descarga de relámpagos" (267308) journal sections:18267 18268
    ...
    -- Add spell "Colisión estridente" (267257) journal sections:18267 18270 18277 18278
    ...
    -- Add spell "Salto sísmico" (268932) journal sections:18249
    ...
    -- Add spell "Guardián eterno" (269351) journal sections:18254 18256
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1178 = BAA:createEAVoicePack("Operación: Mecandria", 396, 1178, "ES")


    -- Expansion "Battle for Azeroth" (396)

    -- Instance "Operación: Mecandria" (1178) (DUNGEON)
    ...
    -- Add spell "Carga eléctrica" (297257) journal sections:20105 20106 20125
    ...
    -- Add spell "Pringue tóxico" (297821) journal sections:20156 20167
    ...
    -- Add spell "Emanaciones tóxicas" (298229) journal sections:20156 20175
    vp1178:addSpellPath(2358,298229,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1178\\2358\\298229.ogg")

    -- Add spell "Ola tóxica" (297834) journal sections:20156 20158
    ...
    -- Encounter "Unidad de opresión aérea KPU7" (2355)

    -- Add spell "Disparo de cañón" (295536) journal sections:20037 20038
    vp1178:addSpellPath(2355,295536,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1178\\2355\\295536.ogg")

    -- Add spell "Relé de refuerzo" (296464) journal sections:20037 20041
    ...
    -- Add spell "Descarga estática" (296518) journal sections:20037 20041 20048 20049
    vp1178:addSpellPath(2355,296518,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1178\\2355\\296518.ogg")

    -- Add spell "Autodestrucción" (296522) journal sections:20037 20041 20048 20052
    ...
    -- Add spell "Explosión de aniquilación" (303206) journal sections:20039 20040 20434
    ...
    -- Add spell "Explosión de conducto" (296150) journal sections:20039 20091 20070
    ...
    -- Add spell "Aceleración máxima" (283565) journal sections:19236 19938
    ...
    -- Add spell "Entrega aérea" (291930) journal sections:19869 19870
    ...
    -- Encounter "Jardín del Maquinista" (2348)
    ...
    -- Add spell "Cañón de llamas "oculto"" (285443) journal sections:19896 19897
    ...
    -- Add spell "Explosión de pétalos" (294860) journal sections:19896 19944 19945
    vp1178:addSpellPath(2348,294860,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1178\\2348\\294860.ogg")

    -- Add spell "Fuente de petróleo" (294863) journal sections:19896 19944 19946
    ...
    -- Add spell "Explosión de pulsos" (291878) journal sections:19874 19876
    ...
    -- Add spell "Recalibración" (291865) journal sections:19874 19907 19908
    ...
    -- Add spell "Explosión de mar" (265001) journal sections:17958
    ...
    -- Add spell "Aguas en erupción" (264903) journal sections:17955
    ...
    -- Add spell "Bendición de la tempestad" (267830) journal sections:17970 18151
    ...
    -- Add spell "Bendición de Proaférrea" (267901) journal sections:18154 18156
    ...
    -- Add spell "Descarga del Vacío" (268347) journal sections:17972
    ...
    -- Add spell "Despertar al Vacío" (269097) journal sections:18236
    vp1036:addSpellPath(2155,269097,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1036\\2155\\269097.ogg")

    -- Add spell "Vacío explosivo" (269104) journal sections:18236 18238 18239
    ...
    -- Add spell "Erupción abisal" (267310) journal sections:18055 18056 18080
    vp1036:addSpellPath(2156,267310,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1036\\2156\\267310.ogg")

    -- Add spell "Embate de tentáculo" (267385) journal sections:18092
    ...
    -- Add spell "Despertar de leviatán" (267548) journal sections:18093 18096 18097
    ...
    -- Add spell "Ira en ebullición" (257649) journal sections:17721 17732
    ...
    -- Add spell "Tromba de cañón" (257585) journal sections:17724
    vp1023:addSpellPath(2132,257585,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1023\\2132\\257585.ogg")

    -- Add spell "Artillería pesada" (273716) journal sections:17724 17759
    ...
    -- Add spell "Salva terrorífica" (268443) journal sections:18227 18228
    vp1023:addSpellPath(2173,268443,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1023\\2173\\268443.ogg")

    -- Add spell "Flagelo carmesí" (268230) journal sections:18230 18231
    ...
    -- Add spell "Aguas pútridas" (274991) journal sections:17817
    ...
    -- Add spell "Erradicación" (269484) journal sections:18926
    ...
    -- Add spell "Escudo de relámpagos" (263246) journal sections:17923
    ...
    -- Add spell "Conducción" (263371) journal sections:18484 17920
    vp1030:addSpellPath(2142,263371,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1030\\2142\\263371.ogg")

    -- Add spell "Choque estático" (263257) journal sections:18484 17931
    ...
    -- Add spell "Golpe de ciclón" (263573) journal sections:18485 17922
    ...
    -- Add spell "Charco tóxico" (263927) journal sections:18024 18032
    ...
    -- Add spell "Cadena de relámpagos" (268061) journal sections:18295 18877
    ...
    -- Add spell "Pulso estático" (262347) journal sections:18320
    ...
    -- Add spell "Detonación cronometrada" (256137) journal sections:17103 17104
    vp1012:addSpellPath(2109,256137,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1012\\2109\\256137.ogg")

    -- Add spell "Puntapié" (255996) journal sections:17103 17106
    ...
    -- Add spell "Imán de monedas" (271898) journal sections:18435 18436
    ...
    -- Add spell "Tótem de hidrofracturación" (257481) journal sections:17113
    ...
    -- Add spell "Infusión de azerita" (257597) journal sections:17114
    ...
    -- Add spell "Machaque tectónico" (275907) journal sections:18711
    ...
    -- Add spell "Quemadura química" (259853) journal sections:17474
    ...
    -- Add spell "Cañón alfa" (260318) journal sections:18916 18927
    ...
    -- Add spell "Carga de conmoción" (262287) journal sections:17498 18452 18454
    vp1012:addSpellPath(2116,262287,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1012\\2116\\262287.ogg")

    -- Add spell "Salto a propulsión" (262436) journal sections:17498 18452 18455
    ...
    -- Add spell "Mácula de G'huun" (260685) journal sections:17937
    ...
    -- Add spell "Festín sanguino" (264757) journal sections:17951
    ...
    -- Add spell "Ráfaga de sangre" (278641) journal sections:17514 17518 17515 18930
    vp1022:addSpellPath(2131,278641,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1022\\2131\\278641.ogg")

    -- Add spell "Indigestión" (260793) journal sections:17513
    ...
    -- Add spell "Putrefacción sin límites" (259830) journal sections:17484
    vp1022:addSpellPath(2130,259830,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1022\\2130\\259830.ogg")

    -- Add spell "Vainas volátiles" (273271) journal sections:18482
    ...
    -- Add spell "Purgar corrupción" (269406) journal sections:18316 18319
    ...
    -- Add spell "Agitación" (257617) journal sections:17122
    ...
    -- Add spell "Vapuleo sañoso" (260067) journal sections:17126 17128 17492
    ...
    -- Add spell "Ignición" (256976) journal sections:16885
    ...
    -- Add spell "Ignición cruzada" (256079) journal sections:17140
    vp1002:addSpellPath(2096,256079,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1002\\2096\\256079.ogg")

    -- Add spell "Ráfaga explosiva" (256101) journal sections:17141
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1021 = BAA:createEAVoicePack("Mansión Crestavía", 396, 1021, "ES")


    -- Expansion "Battle for Azeroth" (396)

    -- Instance "Mansión Crestavía" (1021) (DUNGEON)


    -- Encounter "Tríada Aterracorazón" (2125)
    ...
    -- Add spell "Señal rúnica inestable" (260703) journal sections:17739 17744
    ...
    -- Add spell "Manipulación de alma" (260907) journal sections:17740 17746
    vp1021:addSpellPath(2125,260907,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1021\\2125\\260907.ogg")

    -- Add spell "Aura de apatía" (268077) journal sections:17740 18185
    ...
    -- Add spell "Expulsión pútrida" (264694) journal sections:18207
    vp1021:addSpellPath(2127,264694,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1021\\2127\\264694.ogg")


    -- Encounter "Lord y lady Crestavía" (2128)

    -- Add spell "Conmoción atroz" (268271) journal sections:17773 17774
    ...
    -- Add spell "Patógeno virulento" (261440) journal sections:17777 18216
    ...
    -- Add spell "Vitalidad pútrida" (261447) journal sections:17777 17780
    ...
    -- Add spell "Relámpago oscurecido" (266225) journal sections:18048
    vp1021:addSpellPath(2129,266225,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-ES\\sounds\\1021\\2129\\266225.ogg")

    -- Add spell "Fuego alquímico" (266198) journal sections:18050 18051
