...
function addon:registerSounds()
    ...
    -- Encounter "Prêtresse Alun’za" (2082)
    ...
    -- Add spell "Griffes dorées" (255579) journal sections:16825
    ...
    -- Add spell "Totem de réanimation" (250190) journal sections:16462
    ...
    -- Add spell "Décomposition rapide" (250241) journal sections:16462 16461 16464
    ...
    -- Add spell "Réanimer" (259531) journal sections:16462 17469
    ...
    -- Add spell "Nausée persistante" (250372) journal sections:17470 16488
    ...
    -- Add spell "Os antiques desséchés" (255365) journal sections:16834
    ...
    -- Add spell "Dévorer" (255421) journal sections:17011 16835
    ...
    -- Add spell "Échos de Shadra" (250050) journal sections:16422
    vp968:addSpellPath(2030,250050,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\968\\2030\\250050.ogg")

    -- Add spell "Restes ténébreux" (250036) journal sections:16422 16416
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1001 = BAA:createEAVoicePack("Port-Liberté", 396, 1001, "FR")


    -- Expansion "Battle for Azeroth" (396)

    -- Instance "Port-Liberté" (1001) (DUNGEON)


    -- Encounter "Cap’taine céleste Kragg" (2102)
    ...
    -- Add spell "Bombardement répugnant" (256035) journal sections:17146 17147
    vp1001:addSpellPath(2102,256035,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1001\\2102\\256035.ogg")

    -- Add spell "Bombardement en piqué" (272046) journal sections:17146 18451
    ...
    -- Add spell "Tir de poudre d’azérite" (256106) journal sections:17146 17149
    ...
    -- Add spell "Tirs à la chaîne" (272902) journal sections:17024 18480
    ...
    -- Add spell "Requin frénétique" (256552) journal sections:17162
    vp1001:addSpellPath(2094,256552,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1001\\2094\\256552.ogg")

    -- Add spell "Coup de poing éventreur" (256363) journal sections:17163
    ...
    -- Add spell "Dés pipés : Sur le pont !" (257402) journal sections:17013 17012
    vp1001:addSpellPath(2095,257402,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1001\\2095\\257402.ogg")

    -- Add spell "Dés pipés : Navire de guerre" (257458) journal sections:17013 17015
    ...
    -- Add spell "Halte là !" (257316) journal sections:16946
    ...
    -- Encounter "Le serpent doré" (2165)
    ...
    -- Add spell "Brûlure de la corruption" (267639) journal sections:18140
    vp1041:addSpellPath(2171,267639,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1041\\2171\\267639.ogg")

    -- Add spell "Sol brûlant" (267874) journal sections:18140 18148
    ...
    -- Add spell "Dessèchement" (267626) journal sections:18141 18142
    ...
    -- Add spell "Décharge abjecte" (267763) journal sections:18143 18145 18146
    ...
    -- Add spell "Appel des éléments" (267060) journal sections:18267 18270
    ...
    -- Add spell "Bond de prédateur" (269231) journal sections:18251 18252
    ...
    -- Add spell "Gardien éternel" (269351) journal sections:18254 18256
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1178 = BAA:createEAVoicePack("Opération Mécagone", 396, 1178, "FR")


    -- Expansion "Battle for Azeroth" (396)

    -- Instance "Opération Mécagone" (1178) (DUNGEON)


    -- Encounter "Roi Gobbamak" (2357)

    -- Add spell "Violent coup chargé" (297254) journal sections:20105 20106
    vp1178:addSpellPath(2357,297254,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1178\\2357\\297254.ogg")

    -- Add spell "Charge électrique" (297257) journal sections:20105 20106 20125
    ...
    -- Add spell "Éboulement" (297283) journal sections:20105 20107 20134
    ...
    -- Add spell "Démarrage" (297318) journal sections:20127 20135
    ...
    -- Add spell "Décharge" (297543) journal sections:20127 20129 20131
    ...
    -- Add spell "Pulvérisateur assainissant" (297904) journal sections:20156 20159 20161
    ...
    -- Add spell "Éclaboussement" (297985) journal sections:20156 20157
    ...
    -- Add spell "Brûlure soudaine" (298571) journal sections:20203 20210 20212
    vp1178:addSpellPath(2360,298571,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1178\\2360\\298571.ogg")

    -- Add spell "Nuage de fumée" (298573) journal sections:20203 20210 20212 20213
    vp1178:addSpellPath(2360,298573,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1178\\2360\\298573.ogg")


    -- Encounter "Unité d’oppression aérienne CT-8" (2355)

    -- Add spell "Déflagration de canon" (295536) journal sections:20037 20038
    ...
    -- Add spell "Décharge fulminante" (302274) journal sections:20037 20041 20042 20050
    vp1178:addSpellPath(2355,302274,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1178\\2355\\302274.ogg")

    -- Add spell "Décharge statique" (296518) journal sections:20037 20041 20048 20049
    ...
    -- Add spell "Déflagration d’annihilation" (303206) journal sections:20039 20040 20434
    ...
    -- Add spell "Détraquée" (296080) journal sections:20039 20091 20069 20094 20044
    vp1178:addSpellPath(2355,296080,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1178\\2355\\296080.ogg")

    -- Add spell "Explosion d’évent" (296150) journal sections:20039 20091 20070
    vp1178:addSpellPath(2355,296150,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1178\\2355\\296150.ogg")

    -- Add spell "Téléportation anti-intrus" (296279) journal sections:20039 20091 20068 20071
    ...
    -- Add spell "Largage aérien" (291930) journal sections:19869 19870
    ...
    -- Add spell "Mâchoire ardente" (294929) journal sections:19868 19948
    ...
    -- Add spell "Canon lance-flammes « caché »" (285443) journal sections:19896 19897
    ...
    -- Add spell "Giga-décharge" (291928) journal sections:19874 19879
    vp1178:addSpellPath(2331,291928,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1178\\2331\\291928.ogg")

    -- Add spell "Décollage !" (291613) journal sections:19874 19880
    ...
    -- Add spell "Magnéto-bras" (283534) journal sections:19875 19882
    vp1178:addSpellPath(2331,283534,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1178\\2331\\283534.ogg")

    -- Add spell "Giga-décharge" (292267) journal sections:19875 19909
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1036 = BAA:createEAVoicePack("Sanctuaire des Tempêtes", 396, 1036, "FR")


    -- Expansion "Battle for Azeroth" (396)

    -- Instance "Sanctuaire des Tempêtes" (1036) (DUNGEON)
    ...
    -- Add spell "Eaux en éruption" (264903) journal sections:17955
    ...
    -- Add spell "Espace de rapidité" (267891) journal sections:17970 18149
    vp1036:addSpellPath(2154,267891,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1036\\2154\\267891.ogg")

    -- Add spell "Bénédiction de la tempête" (267830) journal sections:17970 18151
    ...
    -- Add spell "Déflagration tranchante" (267818) journal sections:17970 18153
    ...
    -- Add spell "Bénédiction de Côtefer" (267901) journal sections:18154 18156
    vp1036:addSpellPath(2154,267901,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1036\\2154\\267901.ogg")

    -- Add spell "Enchaînement entravant" (267899) journal sections:18154 18157
    ...
    -- Add spell "Porte béante" (269399) journal sections:18241
    ...
    -- Add spell "Éruption abyssale" (267310) journal sections:18055 18056 18080
    ...
    -- Add spell "Étreinte de la cité engloutie" (267360) journal sections:18093
    ...
    -- Add spell "Sillage du léviathan" (267548) journal sections:18093 18096 18097
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1023 = BAA:createEAVoicePack("Siège de Boralus", 396, 1023, "FR")


    -- Expansion "Battle for Azeroth" (396)

    -- Instance "Siège de Boralus" (1023) (DUNGEON)
    ...
    -- Add spell "Crochet à viande" (275107) journal sections:18641
    ...
    -- Add spell "Tempête d’acier" (260924) journal sections:17756 17757
    ...
    -- Add spell "Évasif" (272471) journal sections:18225
    ...
    -- Add spell "Bordée" (268260) journal sections:18232 18233
    ...
    -- Add spell "Marée déferlante" (261563) journal sections:17792
    ...
    -- Add spell "Vague de marée" (276068) journal sections:17787
    ...
    -- Add spell "Étreinte écrasante" (270624) journal sections:18337 18338 18339
    ...
    -- Add spell "Éradication" (269484) journal sections:18926
    ...
    -- Add spell "Ruée arquée" (263424) journal sections:18485 17921
    ...
    -- Add spell "Éclosion" (264233) journal sections:18027
    ...
    -- Add spell "Nuage de poussière" (268706) journal sections:18027 18030 18194
    ...
    -- Add spell "Nœud de serpents" (263958) journal sections:18321
    ...
    -- Add spell "Énergisant" (280751) journal sections:18922
    ...
    -- Add spell "Fragment d’énergie" (274153) journal sections:18205 18515
    ...
    -- Add spell "Chaîne d’éclairs" (268061) journal sections:18295 18877
    ...
    -- Add spell "Lancer de pièces" (271785) journal sections:18435
    vp1012:addSpellPath(2109,271785,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1012\\2109\\271785.ogg")

    -- Add spell "Aimant en fer à cheval" (271898) journal sections:18435 18436
    ...
    -- Add spell "Projectile guidé" (260811) journal sections:18916 18324
    ...
    -- Add spell "Réacteur de saut" (262436) journal sections:17498 18452 18455
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp1022 = BAA:createEAVoicePack("Les tréfonds Putrides", 396, 1022, "FR")


    -- Expansion "Battle for Azeroth" (396)

    -- Instance "Les tréfonds Putrides" (1022) (DUNGEON)


    -- Encounter "Leaxa l’Aînée" (2157)
    ...
    -- Add spell "Putréfaction insidieuse" (260894) journal sections:17936
    ...
    -- Encounter "Gueule-de-pierre l’Infesté" (2131)

    -- Add spell "Infesté" (260477) journal sections:17514
    vp1022:addSpellPath(2131,260477,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1022\\2131\\260477.ogg")

    -- Add spell "Métamorphose" (260416) journal sections:17514 17518 17519
    vp1022:addSpellPath(2131,260416,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1022\\2131\\260416.ogg")

    -- Add spell "Crocs dentelés" (260455) journal sections:17514 17518 17515 17517
    ...
    -- Add spell "Crise de colère" (260333) journal sections:17512
    ...
    -- Add spell "Récolte purulente" (259732) journal sections:17483
    ...
    -- Add spell "Soulèvement" (259720) journal sections:17482
    vp1022:addSpellPath(2130,259720,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1022\\2130\\259720.ogg")


    -- Encounter "Monstruosité déchaînée" (2158)

    -- Add spell "Barrière de sang" (269185) journal sections:17976
    ...
    -- Add spell "Dagues expéditives" (257785) journal sections:16880
    ...
    -- Add spell "Poudre de fumée" (257793) journal sections:17126
    ...
    -- Add spell "Déviation de lame" (260066) journal sections:17126 17128 17492 17493
    ...
    -- Add spell "Motivé" (257956) journal sections:17131 17132
    ...
    -- Add spell "Allume-mèche" (257033) journal sections:17136
    ...
    -- Add spell "Venin arrête-cœur" (256200) journal sections:17139
    vp1002:addSpellPath(2096,256200,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1002\\2096\\256200.ogg")

    -- Add spell "Munitions en azérite : incendiaires" (256198) journal sections:16870 17137
    ...
    -- Add spell "Munitions en azérite : explosives" (256199) journal sections:16870 17138
    ...
    -- Add spell "Explosion détonante" (256101) journal sections:17141
    ...
    -- Add spell "Déflagration violente" (263345) journal sections:17889
    ...
    -- Add spell "Trait d’âme" (260699) journal sections:17740 17745
    vp1021:addSpellPath(2125,260699,"Interface\\AddOns\\BAA-BattleForAzerothDungeons-FR\\sounds\\1021\\2125\\260699.ogg")

    -- Add spell "Manipulation d’âme" (260907) journal sections:17740 17746
    ...
    -- Add spell "Âmes ardentes" (268045) journal sections:17632 17633 18171
    ...
    -- Encounter "Raal le Bâfreur" (2127)
    ...
    -- Add spell "Transfert de vitalité" (261446) journal sections:17773 17776
    ...
    -- Add spell "Pathogène virulent" (261440) journal sections:17777 18216
    ...
    -- Add spell "Vitalité putride" (261447) journal sections:17777 17780
    ...
    -- Add spell "Invocation d’esclavagiste touché par la mort" (266258) journal sections:18044
