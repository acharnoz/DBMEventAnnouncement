...
function addon:registerSounds()
    ...
    -- Add spell "Umhüllung der Trauer" (203033) journal sections:12728 12733
    ...
    -- Add spell "Flügelstoß" (201355) journal sections:12656
    ...
    -- Add spell "Elementiumeichhörnchenbombe" (201240) journal sections:12611 12613
    ...
    -- Add spell "Verstärkte Dunkelheit" (227178) journal sections:12579 13969
    ...
    -- Add spell "Mächtiges Schmettern" (202328) journal sections:12874
    ...
    -- Add spell "Saat der Zerstörung" (210879) journal sections:13579
    vp777:addSpellPath(1711,210879,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\777\\1711\\210879.ogg")

    -- Add spell "Welle der Zerstörung" (210916) journal sections:13579 13580
    ...
    -- Add spell "Seelensättigung" (196930) journal sections:12245 12247 12248
    ...
    -- Add spell "Rachsüchtiges Scheren" (197418) journal sections:12277 12278
    ...
    -- Add spell "Vermächtnis der Rabenkrone" (199368) journal sections:12509 12511
    ...
    -- Add spell "Dunkle Auslöschung" (199567) journal sections:12509 12512 12515 12964
    ...
    -- Add spell "Würgeranken" (236650) journal sections:15083
    ...
    -- Add spell "Betörende Biografie" (238484) journal sections:15071 15427 15072
    ...
    -- Add spell "Sengende Präsenz" (241607) journal sections:15076 15352 15349 15350
    ...
    -- Add spell "Dämonischer Aufruhr" (233196) journal sections:14949 14764
    vp900:addSpellPath(1878,233196,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\900\\1878\\233196.ogg")

    -- Add spell "Dämonischer Aufruhr" (243168) journal sections:14949 15545
    vp900:addSpellPath(1878,243168,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\900\\1878\\243168.ogg")

    -- Add spell "Düstere Einsamkeit" (234817) journal sections:14949 14847
    ...
    -- Add spell "Schatten ausstoßen" (234217) journal sections:14950 15542 14770
    ...
    -- Add spell "Würgewurzeln" (199063) journal sections:12303 13085
    ...
    -- Add spell "Erderschütterndes Gebrüll" (199389) journal sections:12311 12517
    vp762:addSpellPath(1656,199389,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\762\\1656\\199389.ogg")

    -- Add spell "Welpling ausbrüten" (199313) journal sections:13770 13771
    ...
    -- Add spell "Eingeflüsterte Paranoia" (200359) journal sections:12317 12547
    ...
    -- Add spell "Apokalyptische Ermächtigung" (221315) journal sections:12317 12543 13776
    ...
    -- Add spell "Verstärkung rufen" (192072) journal sections:12415
    vp716:addSpellPath(1480,192072,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\716\\1480\\192072.ogg")

    -- Add spell "Dröhnendes Gebrüll" (192135) journal sections:12415 12416 12417
    ...
    -- Add spell "Verstärkung rufen" (196563) journal sections:12027
    ...
    -- Add spell "Gebündelter Blitz" (193611) journal sections:12137
    vp716:addSpellPath(1490,193611,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\716\\1490\\193611.ogg")

    -- Add spell "Überschüssige Blitzschläge" (193624) journal sections:12137 13984
    ...
    -- Encounter "König Klafterbart" (1491)
    ...
    -- Add spell "Erde erschüttern" (193093) journal sections:12172
    ...
    -- Add spell "Toxische Pfütze" (191856) journal sections:12012 12084
    ...
    -- Add spell "Tobende Stürme" (192696) journal sections:12090
    vp716:addSpellPath(1492,192696,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\716\\1492\\192696.ogg")

    -- Add spell "Erdrückende Tiefen" (197365) journal sections:12272
    ...
    -- Encounter "Ymiron, der gefallene König" (1502)
    ...
    -- Add spell "Eitrige Fäulnis" (193367) journal sections:12148
    ...
    -- Add spell "Bruchstück" (194325) journal sections:12214
    ...
    -- Add spell "Aufgewühltes Wasser" (197858) journal sections:13982 12776
    vp727:addSpellPath(1663,197858,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\727\\1663\\197858.ogg")

    -- Add spell "Verderbtes Brüllen" (227233) journal sections:12367 12368 13983
    ...
    -- Add spell "Flügelstoß" (198520) journal sections:12367 12368 12429
    ...
    -- Add spell "Spröde" (187714) journal sections:12348
    ...
    -- Add spell "Zertrümmern" (188114) journal sections:12347
    ...
    -- Add spell "Dröhnen der Tiefen" (193375) journal sections:12439
    vp767:addSpellPath(1665,193375,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\767\\1665\\193375.ogg")

    -- Add spell "Fallende Trümmer" (193267) journal sections:12439 12440 12441
    ...
    -- Add spell "Zerreißen" (198496) journal sections:12443
    ...
    -- Add spell "Unersättlich" (199246) journal sections:12522 12525 12526
    ...
    -- Encounter "Dargrul der Unterkönig" (1687)
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp860 = BAA:createEAVoicePack("Rückkehr nach Karazhan", 395, 860, "DE")


    -- Expansion "Legion" (395)

    -- Instance "Rückkehr nach Karazhan" (860) (DUNGEON)


    -- Encounter "Der Opernsaal: Wikket" (1820)

    -- Add spell "Düsterer Blitz" (227543) journal sections:14020 14021
    vp860:addSpellPath(1820,227543,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\860\\1820\\227543.ogg")

    -- Add spell "Assistenten beschwören" (227477) journal sections:14020 14022
    ...
    -- Add spell "Feuriger Fußfeger" (227568) journal sections:14117 14118 14121
    ...
    -- Add spell "Wegspülen" (227783) journal sections:14124 14125 14127
    ...
    -- Encounter "Opernsaal: Das schöne Biest" (1827)
    ...
    -- Add spell "Durchnässt" (228013) journal sections:14148 14149 14177
    ...
    -- Add spell "Heißer Feger" (228225) journal sections:14151 14153
    ...
    -- Add spell "Rüstung verbeulen" (227985) journal sections:14142 14143
    ...
    -- Add spell "Gleißende Gabeln" (232142) journal sections:14142 14565 14566 14568
    ...
    -- Add spell "Massenbuße" (227508) journal sections:14109
    ...
    -- Encounter "Attumen der Jäger" (1835)

    -- Add spell "Körperlose Präsenz" (227404) journal sections:14300 14301
    vp860:addSpellPath(1835,227404,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\860\\1835\\227404.ogg")

    -- Add spell "Mächtiges Stampfen" (227363) journal sections:14300 14302
    ...
    -- Add spell "Tödlicher Stoß" (227493) journal sections:14304 14306
    ...
    -- Add spell "Geisterhafte Läuterung" (227872) journal sections:14360 14364
    ...
    -- Add spell "Unstete Energie beschwören" (227267) journal sections:14323 14326
    vp860:addSpellPath(1836,227267,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\860\\1836\\227267.ogg")

    -- Add spell "Überspringender Blitz" (227270) journal sections:14323 14326 14327 14328
    ...
    -- Add spell "Überladung" (227257) journal sections:14324 14325
    ...
    -- Add spell "Durchstoßende Geschosse" (227628) journal sections:14035
    ...
    -- Add spell "Abbild des Wächters" (228334) journal sections:14036 14267
    ...
    -- Add spell "Dunkler Ausstoß" (244599) journal sections:15865 15880 15871
    ...
    -- Add spell "Schnelligkeit des Jägers" (247145) journal sections:16070 16242
    ...
    -- Add spell "Falle überladen" (247206) journal sections:16070 16075
    ...
    -- Encounter "Vizekönig Nezhar" (1981)
    ...
    -- Add spell "Instabiler Übergang" (249082) journal sections:15923 15926 15927 16370
    vp945:addSpellPath(1981,249082,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\945\\1981\\249082.ogg")

    -- Add spell "Leerengeißel" (244916) journal sections:15923 15926 15927 15928
    vp945:addSpellPath(1981,244916,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\945\\1981\\244916.ogg")

    -- Add spell "Leerengeißel" (248733) journal sections:15923 15926 15927 15928 16333
    ...
    -- Add spell "Große Verschiebung" (249009) journal sections:16000 16293 16367
    ...
    -- Add spell "Überrest der Qual" (245242) journal sections:16005 16368
    ...
    -- Add spell "Mana überladen" (196392) journal sections:12266
    vp726:addSpellPath(1497,196392,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\726\\1497\\196392.ogg")

    -- Add spell "Überladen" (196396) journal sections:12266 12267
    ...
    -- Add spell "Quarantäne" (195791) journal sections:12191
    vp726:addSpellPath(1498,195791,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\726\\1498\\195791.ogg")

    -- Add spell "Unterdrückungsprotokoll" (196070) journal sections:12192
    ...
    -- Add spell "Läuternde Macht" (196115) journal sections:12194
    ...
    -- Add spell "Tückisches Zerschmettern" (197810) journal sections:12486
    ...
    -- Add spell "Blinzelstöße" (199811) journal sections:12687
    ...
    ---------------------------------------------------------------------------
    ---------------------------------------------------------------------------
    local vp707 = BAA:createEAVoicePack("Das Verlies der Wächterinnen", 395, 707, "DE")


    -- Expansion "Legion" (395)

    -- Instance "Das Verlies der Wächterinnen" (707) (DUNGEON)
    ...
    -- Add spell "Seelenschwächung" (200905) journal sections:12672
    vp707:addSpellPath(1695,200905,"Interface\\AddOns\\BAA-LegionDungeons-DE\\sounds\\707\\1695\\200905.ogg")

    -- Add spell "Quälende Kugel beschwören" (212567) journal sections:13469
    ...
    -- Add spell "Verderbte Berührung" (206019) journal sections:12880 12896 12897 12902
    ...
    -- Add spell "Monströser Biss" (125096) journal sections:12880 12885 12898 12904
    ...
    -- Add spell "Spröde" (192517) journal sections:12727 12100
    ...
    -- Add spell "Überladung" (225817) journal sections:12664 13902
    ...
    -- Add spell "Fußfeger" (197251) journal sections:12402
